...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("Boleh Gabung ga??")
    sleep(1)
    await typew.edit("Yallah cakep cakep amat 😔")
    sleep(1)
    await typew.edit("Insinyur jadinyaaaa 😭 Eh insecure 😔")
    sleep(1)
    await typew.edit("Dahlahh 😔")
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("se**TOLOL** **TOLOL** nya  **K0NTOL KAO**")
    sleep(1)
    await typew.edit("lebih **TOLOL** lagi")
    sleep(1)
    await typew.edit("YA KONTOL KAO")
    await typew.edit("KAO **T**")
    await typew.edit("KAO **To**")
    await typew.edit("KAO **TOL**")
    await typew.edit("KAO **TOLO**")
    await typew.edit("KAO **TOLOO**")
    await typew.edit("KAO **KONTOL**")
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("Tampang serem")
    sleep(1)
    ...
    sleep(1)
    await typew.edit("Pokoknya NTT Pro Dah")
    sleep(1)
...
async def typewriter(typew):
    ...
    await typew.edit("🤖")
    sleep(2)
    await typew.edit("**⌬ 𝘈𝘭𝘱𝘩𝘢 𝘜𝘴𝘦𝘳𝘣𝘰𝘵 ⌬**\n\n [𝚂𝚎𝚗𝚝𝚞𝚑 𝙰𝚔𝚞 𝙱𝚎𝚋](https://pornhub.com)\n 𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠")
...
CMD_HELP.update({
    "animasi1":
    "📚 **Cmd** : .hai\
    \n📄 **Descriptions** : `Cosplay Nissa Sablon`\
    \n\n📚 **Cmd** : .kntl\
    \n📄 **Descriptions** : `Cek Aja dh`\
    \n\n📚 **Cmd** : .alay\
    \n📄 **Descriptions** : `Lumayanlah Buat Nyindir`\
    \n\n📚 **Cmd** : .ange\
    \n📄 **Descriptions** : `Ketik Ini Kalo Lu Lagi Sange`\
    \n\n📚 **Cmd** : .lopu\
    \n📄 **Descriptions** : `Nyatakan Cinta Ke Cewe Orng`\
    \n\n📚 **Cmd** : .hujan\
    \n📄 **Descriptions** : `Penyesalan Seorang Laki-laki Yang Diulangin Terus Menerus`\
    \n\n📚 **Cmd** : .dahlah\
    \n📄 **Descriptions** : `Cek Aja dh sndri`\
    \n\n📚 **Cmd** : .jawa\
    \n📄 **Descriptions** : `Jawa Pride Ni Bos.`\
    \n\n📚 **Cmd** : .erpe\
    \n📄 **Descriptions** : `Buat Nyindir Nak Rp Yg Goblok.`"
